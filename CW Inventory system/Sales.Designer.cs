...
namespace CW_Inventory_system.SalesTableAdapters {
    ...
    public partial class tborderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [tborder] WHERE (([orderid] = @Original_orderid) AND ([odate] = @Orig" +
                "inal_odate) AND ([pid] = @Original_pid) AND ([cid] = @Original_cid) AND ([qty] =" +
                " @Original_qty) AND ([price] = @Original_price) AND ([total] = @Original_total))" +
                "";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [tborder] ([odate], [pid], [cid], [qty], [price], [total]) VALUES (@o" +
                "date, @pid, @cid, @qty, @price, @total);\r\nSELECT orderid, odate, pid, cid, qty, " +
                "price, total FROM tborder WHERE (orderid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [tborder] SET [odate] = @odate, [pid] = @pid, [cid] = @cid, [qty] = @qty, [price] = @price, [total] = @total WHERE (([orderid] = @Original_orderid) AND ([odate] = @Original_odate) AND ([pid] = @Original_pid) AND ([cid] = @Original_cid) AND ([qty] = @Original_qty) AND ([price] = @Original_price) AND ([total] = @Original_total));
SELECT orderid, odate, pid, cid, qty, price, total FROM tborder WHERE (orderid = @orderid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CW_Inventory_system.Properties.Settings.Default.DBMSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT orderid, odate, pid, cid, qty, price, total FROM tborder";
        ...
        public virtual int Fill(Sales.tborderDataTable dataTable) {
        ...
        public virtual Sales.tborderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Sales.tborderDataTable dataTable = new Sales.tborderDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Sales.tborderDataTable dataTable) {
